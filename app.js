...
var val_opt_random = ["papel","piedra","tijera"];
function opt_random(){
...
function game_vs(select_player1,select_player2){
    ...
    if (vs == "p1win") {
        document.getElementById("result").innerText = "¡Ganaste! ¡qué crack!";
        ...
        document.getElementById("result").style.color = "#B8860B"
    } else if (vs == "p2win"){
        document.getElementById("result").innerText = "¡Perdiste! ¡qué feo!";
